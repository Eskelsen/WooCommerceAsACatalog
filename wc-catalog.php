...
class WooCommerce_External_Catalog {
    ...
    public function register_settings() {
        ...
        add_settings_section('wec_main_section', '', null, $this->option_name);
    ...
    public function field_hide_prices_html() {
        ...
        echo '<label><input type="checkbox" name="' . $this->option_name . '[hide_prices]" value="1" ' . $checked . '> Ativar modo catálogo (oculta preços)</label>';
    }
    ...
    public function settings_page_html() {
        ?>
        <div class="wrap">
            <h1>WooCommerce External Catalog</h1>
    ...
    public function add_external_link_field() {
        woocommerce_wp_text_input([
            'id'          => 'link_externo',
            'label'       => 'Link Externo',
            'placeholder' => 'https://nova-loja.com/produto/...',
            'desc_tip'    => true,
            'description' => 'URL do produto na nova loja',
        ]);
    }
    ...
    public function add_external_button() {
        ...
        if ($link_externo) {
            echo '<a href="' . esc_url($link_externo) . '" class="button alt" target="_blank" rel="noopener noreferrer">Comprar na nova loja</a>';
        }
    }
...
new WooCommerce_External_Catalog();
