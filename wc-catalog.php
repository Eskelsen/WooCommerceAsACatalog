...
add_action('init', function() {
	...
	// add_filter('woocommerce_is_purchasable', '__return_false'); # removed 03/12/25
	add_filter('woocommerce_is_sold_individually', '__return_true');
	// add_filter('woocommerce_product_add_to_cart_url', '__return_empty_string'); # removed 03/12/25
